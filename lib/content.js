...
export const whyBawsala = [
  {
    title: "Executive Mentorship",
    desc: "Receive personalized guidance from senior leaders across government, business, diplomacy, and civil society.",
    icon: "compass",
  },
  {
    title: "Leadership Development",
    desc: "Build practical leadership capabilities through workshops, simulations, and real-world challenges.",
    icon: "spark",
  },
  {
    title: "National Perspective",
    desc: "Develop a deeper understanding of Oman's priorities, opportunities, and future direction.",
    icon: "globe",
  },
  {
    title: "Institutional Access",
    desc: "Visit leading institutions and engage directly with decision-makers.",
    icon: "building",
  },
  {
    title: "Powerful Network",
    desc: "Join a community of ambitious young Omanis committed to creating positive impact.",
    icon: "network",
  },
  {
    title: "Lifelong Community",
    desc: "Become part of an alumni network that continues beyond the program itself.",
    icon: "people",
  },
];
...
export const eligibility = [
  "Are an Omani national",
  "Are currently enrolled in a university or have recently graduated within 2 years",
  "Demonstrate leadership potential",
  "Are committed to contributing to Oman's development",
  "Are eager to learn, grow, and challenge yourself",
  "Want to join a community of future leaders",
];
