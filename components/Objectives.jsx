...
export default function Objectives() {
  return (
    <section id="objectives" className="relative py-24 sm:py-32">
      <div className="container-x">
        <SectionHeading
          eyebrow="Our Objectives"
          title="What the Fellowship Sets Out to Achieve"
          subtitle="Every part of the program is designed around a clear set of goals for each fellow's growth and for Oman's future."
        />
