...
const paths = {
  ...
  spark: (
    <path d="M12 3l1.9 5.5L19.5 10l-5.6 1.5L12 17l-1.9-5.5L4.5 10l5.6-1.5L12 3z" />
  ),
  globe: (
    <>
      <circle cx="12" cy="12" r="9" />
  ...
  network: (
    <>
      ...
      <path d="M7.8 7.8l3 8.4M16.2 7.8l-3 8.4M8.5 6h7" />
    </>
  ),
  people: (
    <>
      ...
      <path d="M16 4.5a3 3 0 0 1 0 7M21 20c0-2.5-1.5-4.6-3.6-5.5" />
    </>
  ),
  target: (
    <>
